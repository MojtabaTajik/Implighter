# How implighter works

Design notes: why the extension is built the way it is, and what each rule exists to prevent.
Most of it was written after hitting the failure it describes.

For installing and using the extension, see the [README](../README.md).
